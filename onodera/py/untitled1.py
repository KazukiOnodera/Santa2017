...
wish = pd.read_csv(INPUT_PATH + 'child_wishlist_v2.csv.zip', header=None).as_matrix()[:, 1:]
gift_init = pd.read_csv(INPUT_PATH + 'gift_goodkids_v2.csv.zip', header=None).as_matrix()[:, 1:]
gift = gift_init.copy()
...
df = pd.read_csv(INPUT_PATH+"sample_submission_random_v2.csv.zip")
df['GiftId'] = answ
